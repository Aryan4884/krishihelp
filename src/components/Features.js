            ...
            <div class="homePageCardcol col">
              <div className="card homePageCardBody eitherSideCard ">
                ...
                <div className="card-body">
                  ...
                  <a href="https://weatherforecasting04.netlify.app" className="btn homepageCardBtn btn-primary">
                    Explore
                  </a>
                </div>
              </div>
            ...
            <div class="homePageCardcol col">
              <div className="card homePageCardBody eitherSideCard ">
                ...
                <div className="card-body">
                  ...
                  <a href="https://agrio.app/" className="btn homepageCardBtn btn-primary">
                    Explore
                  </a>
                </div>
              </div>
